...
2/ intégration des bibliothèques spring (3.1.0 - pas d'utilisation de maven :(
3/ création du projet public sur github (springHelloWorldTerminal)
4/ intégration du projet en git local
5/ en ligne de commande, à la racine du dépot local :  
   git remote add origin git@github.com:sio-melun/springHelloWorldTerminal.git
